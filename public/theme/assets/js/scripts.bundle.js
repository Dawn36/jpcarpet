            ...
            U = function(e) {
                if (!1 !==
                    ...
                    null !== a && a >= o && (o = a + 1),
                        ...
                        KTUtil.addClass(t, "show"), !0 === x(e, "overflow") ?
            ...
            w = function(e) {
                if (!1 !==
                    ...
                    KTUtil.css(t, "z-index", ""),
                        ...
                        KTUtil.removeClass(t, "show"), !0 === x(e, "overflow") &&
    ...
    if (e) {
        var i = {
            ...
            a = function() {
                var e = 0,
                    t = m();
                !0 === l() && (e += t), !0 === n.options.checkUppercase && !0 === s() && (e += t), !0 === n.options.checkLowercase && !0 === u() && (e += t), !0 === n.options.checkDigit && !0 === d() && (e += t), !0 === n.options.checkChar && !0 === c() && (e += t),
                    (n.score = e),
                    f();
            },
            l = function() {
            ...
            m = function() {
                var e = 1;
                return (!0 === n.options.checkUppercase && e++, !0 === n.options.checkLowercase && e++, !0 === n.options.checkDigit && e++, !0 === n.options.checkChar && e++,
                    (n.checkSteps = e),
                    100 / n.checkSteps
                );
            },
            ...
            a = function() {
                ...
                !0 === u("activate") ||
                    ...
                    ((e = d()),
                        ...
                        KTUtil.css(n.element, e, ""), !0 === u("save-state") && void 0 !== KTCookie && n.id ?
        ...
        var i = {
            ...
            o = function() {
                n.inputElement.addEventListener("focus", a),
                    n.inputElement.addEventListener("blur", l), !0 === g("keypress") &&
                    n.inputElement.addEventListener("input", u),
                    n.submitElement &&
                    n.submitElement.addEventListener("click", d), !0 === g("enter") &&
            ...
            c = function() {
                !1 !==
                    ...
                    ((n.inputElement.value = ""),
                        ...
                        n.toolbarElement &&
                        n.formElement.contains(n.toolbarElement) &&
                        n.toolbarElement.classList.remove("d-none"), !1 === g("show-on-focus") && p(),
                ...
                if (t && t.length > 0)
                    for (var i = 0, r = t.length; i < r; i++) {
                        ...
                        if (
                            ...
                            if (
                                (KTUtil.addClass(o, "current"), !1 !== n.options.animation &&
                                    "content" ==
                                    o.getAttribute(
                ...
                !1 !== o &&
                    ((o = parseInt(o)),
                        ...
                        (r =
                            ...
                            window.innerHeight -
                            KTUtil.getScrollTop()), !0 === d ?
                        (t > o && (0 === a || a < r) ?
                            (!1 === i.hasAttribute(n.attributeName) &&
                                (l(),
                                    i.setAttribute(n.attributeName, "on")), !0 === n.eventTriggerState &&
                                (KTEventHandler.trigger(
                                        n.element,
                                        "kt.sticky.on",
                                        n
                            ...
                            (!0 === i.hasAttribute(n.attributeName) &&
                                (s(), i.removeAttribute(n.attributeName)), !1 === n.eventTriggerState &&
                                (KTEventHandler.trigger(
                                        n.element,
                                        "kt.sticky.off",
                                        n
                        ...
                        t > o && (0 === a || a < r) ?
                        (!1 === i.hasAttribute(n.attributeName) &&
                            (l(), i.setAttribute(n.attributeName, "on")), !0 === n.eventTriggerState &&
                            (KTEventHandler.trigger(
                                    n.element,
                                    "kt.sticky.on",
                                    n
...
"loading" === document.readyState ?
    ...
    (function() {
        for (
            var e = 0, t = ["webkit", "moz"], n = 0; n < t.length && !window.requestAnimationFrame;
            ++n
        )
    ...
    (Element.prototype.getAttributeNames = function() {
        for (
            var e = this.attributes, t = e.length, n = new Array(t), i = 0; i < t; i++
        )
            n[i] = e[i].name;
        return n;
    }),
    ...
    return {
        ...
        getViewPort: function() {
            ...
            return (
                ...
                ((t = "client"),
                    (e = document.documentElement || document.body)), { width: e[t + "Width"], height: e[t + "Height"] }
            );
        },
        ...
        sleep: function(e) {
            for (
                var t = new Date().getTime(), n = 0; n < 1e7 && !(new Date().getTime() - t > e); n++
            );
        },
            ...
            if (null !== e) {
                ...
                return (
                    (window.KTUtilDelegatedEventHandlers[r] = function(n) {
                        for (
                            var r = e.querySelectorAll(t), o = n.target; o && o !== e;
        ...
        animateDelay: function(e, t) {
            for (
                var n = ["webkit-", "moz-", "ms-", "o-", ""], i = 0; i < n.length; i++
            )
...
var KTApp = (function() {
    var e = !1,
        ...
        n = function(e, t) {
            ...
            e.hasAttribute("data-bs-delay-hide") &&
                ...
                (n.show = e.getAttribute("data-bs-delay-show")),
                n && (t.delay = n),
                "true" == e.getAttribute("data-bs-dismiss") && (t.dismiss = !0), !0 === t.dismiss &&
                (t.template =
    ...
    return {
        ...
        initCountUpTabs: function() {
            i(),
                window.addEventListener("scroll", i), [].slice
                .call(
                    document.querySelectorAll(
