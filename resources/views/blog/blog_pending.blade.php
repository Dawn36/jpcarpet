                    ...
                    <div class="card card-docs mb-2">
                        <div class="p-10">
                            <h1 class="anchor fw-bolder mb-5" id="zero-configuration">
                                <a href="javascript:;"></a>Pending Blogs Listing
                            </h1>
                            <div class="d-flex align-items-center rounded py-5 px-4 bg-light-primary">
                                ...
                                <div class="text-gray-700 fw-bold fs-6 lh-lg">Here is the list of all of the Blogs that we have.</div>
                            </div>
                        </div>
                        <div class="card-header border-0">
                            ...
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    <button type="button" class="btn btn-primary me-2" onclick="addBlog()">
                                ...
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ucwords($blog[$i]->first_name)}} {{ucwords($blog[$i]->last_name)}}</td>
                                            <td>{{Date("Y-m-d",strtotime($blog[$i]->created_at))}}</td>
                                            <td>
                                                <a href="{{ route('blog_accept', $blog[$i]->id) }}" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-success" data-bs-toggle="tooltip" data-bs-original-title="Accept Blog">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <a href="{{ route('blog_reject', $blog[$i]->id) }}" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger" data-bs-toggle="tooltip" data-bs-original-title="Reject Blog" >
