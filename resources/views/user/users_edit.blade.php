<form id="" class="form" method="POST" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data">
    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        ...
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Facebook Link</label>
            <input type="text" value="{{$user->facebook}}" name="facebook" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="please enter company name." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Instagram link</label>
            <input type="text" value="{{$user->insta}}" name="insta" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="please enter company name." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">linkedin link</label>
            <input type="text" value="{{$user->link_in}}" name="link_in" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="please enter company name." />
        </div>
        <div class="fv-row mb-7">
