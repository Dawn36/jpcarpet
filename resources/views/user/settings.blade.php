                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#"
                                                class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $data['first_name'] }}</a>
                                            <a href="#">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="facebook"
                                            class="form-control form-control-lg form-control-solid"
                                            placeholder="facebook link" value="{{ $data['facebook'] }}" />
                                    </div>
                                </div>
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="insta"
                                            class="form-control form-control-lg form-control-solid"
                                            placeholder="Instagram link" value="{{ $data['insta'] }}" />
                                    </div>
                                </div>
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">linkedin Link</label>
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="link_in"
                                            class="form-control form-control-lg form-control-solid"
                                            placeholder="linkedin link" value="{{ $data['link_in'] }}" />
                                    </div>
                                </div>
                            </div>
