...
<head>
    ...
    <title>How To: {{ucwords($blogDetails[0]->blog_name)}} | JP Carpet Cleaning</title>
    <meta name="description" content="{{$blogDetails[0]->meta_description}}" />
    <meta name="keywords" content="{{$blogDetails[0]->meta_keywords}}">

    <meta name="robots" content="index, follow">
    <meta name="author" content="Peter Shams">
    <link rel="canonical" href="{{env('URL')}}how-to-clean-terrazzo-floor.html">
    <link rel="alternate" hreflang="en" href="{{env('URL')}}how-to-clean-terrazzo-floor.html" />
...
<body>
    ...
    <section class="bg-img light-color overlay-before">
        <div class="container">
            <div class="row title">
                <div class="title_row">
                    <h1 data-title="{{ucwords($blogDetails[0]->blog_name)}}">{{ucwords($blogDetails[0]->blog_name)}}</h1>
                    <div class="page-breadcrumb"> <a title="professional area rug cleaning">Home</a> / Blog / {{ucwords($blogDetails[0]->blog_name)}}</div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 blog-post-hr post-section">
                    <div class="blog-post mb-30">
                        ...
                        <div class="mt-5">
                          @php echo html_entity_decode($blogDetails[0]->i_frame_link) @endphp
